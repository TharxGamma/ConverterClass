...
Converter::Converter(int InputInteger)
{
    this->Hex = IntegerToHex(InputInteger);
} 
...
int main()
{
    ...
    Converter ConvertIntegerToHex(10);

    std::cout << ConvertHexToInteger.GetIntegerValue() << std::endl;
    std::cout << ConvertIntegerToHex.GetHexValue() << std::endl;
